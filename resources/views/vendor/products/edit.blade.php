                        ...
                        <form action="{{ route('vendor.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="prix_promo" class="form-control rounded-3" value="{{ old('prix_promo', $product->prix_promo) }}">
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-12">
                                    ...
                                    <div>
                                        ...
                                        <input type="url" name="image" class="form-control rounded-3" value="{{ old('image', $product->image) }}" oninput="previewImage(this.value)">
                                    </div>
