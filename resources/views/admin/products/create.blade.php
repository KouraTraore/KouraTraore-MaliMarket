                        ...
                        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <input type="text" name="nom" class="form-control rounded-3" placeholder="Ex: Samsung Galaxy A54" value="{{ old('nom') }}" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-bold">Prix (FCFA)</label>
                                    <input type="number" name="prix" class="form-control rounded-3" placeholder="Ex: 285000" value="{{ old('prix') }}" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-bold">Prix promo (optionnel)</label>
                                    <input type="number" name="prix_promo" class="form-control rounded-3" placeholder="Ex: 265000" value="{{ old('prix_promo') }}">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-bold">Stock</label>
                                    <input type="number" name="stock" class="form-control rounded-3" placeholder="Ex: 10" value="{{ old('stock', 0) }}" required>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="vendor_id" class="form-select rounded-3" required>
                                        ...
                                        @foreach($vendors as $vendor)
                                            <option value="{{ $vendor->id }}" {{ old('vendor_id') == $vendor->id ? 'selected' : '' }}>{{ $vendor->nom_boutique }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="description" class="form-control rounded-3" rows="4" placeholder="Description du produit...">{{ old('description') }}</textarea>
                                </div>
                                <div class="col-12">
