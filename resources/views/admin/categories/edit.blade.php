...
<head>
    ...
    <title>Modifier Catégorie - MaliMarket Admin</title>
...
<div class="main-content">
    <div class="topbar d-flex justify-content-between align-items-center">
        <h5 class="mb-0 fw-bold"><i class="fas fa-edit me-2"></i>Modifier : {{ $category->nom }}</h5>
                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('admin.categories.update', $category->id) }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="url" name="image" id="imageUrl" class="form-control rounded-3"
                                    value="{{ old('image', $category->image) }}"
                                    oninput="previewImage(this.value)">

                                <div id="imagePreview" class="mt-3" style="{{ $category->image ? '' : 'display:none;' }}">
                                    <img id="previewImg" src="{{ $category->image }}" class="rounded-3 w-100"
                            ...
                            <div class="mb-4">
                                <div class="form-check form-switch">
                                    ...
                                    <label class="form-check-label fw-bold" for="active">Catégorie active</label>
                                </div>
                            </div>
