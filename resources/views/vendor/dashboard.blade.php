            ...
            <div class="col-lg-6">
                <div class="card border-0 shadow-sm rounded-4">
                    <div class="card-header bg-white border-0 pt-4 px-4 d-flex justify-content-between">
                        ...
                        <a href="{{ route('vendor.products.index') }}" class="btn btn-sm btn-outline-warning rounded-pill">Voir tout</a>
                    </div>
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item px-4 py-3">
                                <div class="d-flex align-items-center gap-3">
                                    @if($produit->image)
                                        <img src="{{ asset($produit->image) }}" class="rounded-3"
            ...
            <div class="card-body p-4">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        @if($vendor->statut == 'approuve')
                            <span class="badge bg-success px-3 py-2">Approuvée</span>
                        @elseif($vendor->statut == 'en_attente')
                            <span class="badge bg-warning px-3 py-2">En attente</span>
                        @else
                            <span class="badge bg-danger px-3 py-2">Suspendue</span>
                        @endif
                    </div>
                </div>
            </div>
